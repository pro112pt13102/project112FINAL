...
public class Badge extends FrameLayout {
    ...
    public Badge(Context context, AttributeSet attrs) {
        ...
        try {
            mBadgeTextColor = a.getColor(R.styleable.NotificationBadge_nbTextColor, ContextCompat.getColor(getContext(),android.R.color.holo_red_dark));
            mTvBadgeText.setTextColor(mBadgeTextColor);

            mBadgeTextSize = a.getDimensionPixelSize(R.styleable.NotificationBadge_nbTextSize, 45);
...
//                Drawable badgeBackground = a.getDrawable(R.drawable.ic_launcher_background);
            ...
            mIvBadgeBg.setImageResource(R.drawable.bg_badge);
